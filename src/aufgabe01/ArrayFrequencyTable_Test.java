 ...
 * @author oliverbittel
 * @since 04.03.2021
 * test auf Laptop dauert knapp über 13 Minuten
 */
public class  ArrayFrequencyTable_Test {
	...
	private static void test1() {
		// Test von add:
		FrequencyTable tab1 = new LinkedArrayFreqTable();
		tab1.add("das");
		tab1.add("ist");
		tab1.add("ein",2);
		tab1.add("Test");
		...
		// Test von addAll:
		FrequencyTable tab2 = new LinkedArrayFreqTable();
		tab2.add("das",2);
		tab2.add("ist",4);
		tab2.add("kurzer");
		tab2.add("Text");
	...
	private static void test2() throws FileNotFoundException, IOException {
		FrequencyTable tab = new LinkedArrayFreqTable();
		...
		while ((line = in.readLine()) != null) {
			...
			for (String w: wf) {
				...
				tab.add(w);
				index++;
				//if(index%10000 == 0) // Test Anzahl Wörter
				//System.out.println("Anzahl :" + index );
			}
		}	
